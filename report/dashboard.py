...
class ReportDropdown(Dropdown):
    ...
    def build_component(self, id=None, model=None):
        ...
        return super().build_component(id=id, model=model)
    
    # Overwrite the `component_data` method
    # Ensure the method uses the same parameters
    # as the parent class method
    def component_data(self, id=None, model=None):
...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, model=None, asset_id=None):
        ...
        ax.set_title('Employee Event Counts')
        ax.set_xlabel('Date')
...
class NotesTable(DataTable):
    ...
    def component_data(self, id=None, model=None, entity_id=None):
